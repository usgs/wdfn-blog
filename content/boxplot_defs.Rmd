...
```{r visualizeBox, fig.cap="ggplot2 box plot with explanation.", alt.text="ggplot2 box plot with explanation.",fig.height=7,  fig.width=3, warnings = FALSE, class="sideBySide"}
