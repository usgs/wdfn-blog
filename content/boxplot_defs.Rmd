...
```{r getChoride, fig.width = 7, fig.height=5}
...
```{r chlorideWithLegend, fig.cap="Chloride by month styled.", fig.alt="Chloride by month, styled.", warning=FALSE, fig.height=5}
library(cowplot)
...
```{r phosDistribution, fig.cap="Phosphorus distribution by month.", fig.alt="Phosphorus distribution by month.", warning=FALSE, fig.height=5}
site <- "05427948"
pCode <- "00665"
...
```{r comboGraph, fig.width=7, fig.height=7}
...
```{r picsWithDL, warning=FALSE, fig.height=5}
