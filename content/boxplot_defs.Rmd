...
Next, we calculate the important limits, and put those values into another data frame (lablel_df):
...
```{r visualizeBox, fig.cap="ggplot2 box plot with explanation.", alt.text="ggplot2 box plot with explanation."}
library(ggplot2)
