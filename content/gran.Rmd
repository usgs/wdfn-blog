...
keyword1: "automated builds of R repository"
...
[https://owi.usgs.gov/R/training-curriculum/intro-curriculum/Before/](https://owi.usgs.gov/R/training-curriculum/intro-curriculum/Before/)
...
[https://owi.usgs.gov/R/gran.html](https://owi.usgs.gov/R/gran.html)
...
8. The source and Windows binaries are sent to the Amazon S3 buckets via the command line.
9. There is a check to make sure there are the same number of packages up on the server as in the `grantools` list.
10. A similar process has been developed for the Mac binary builds. 
11. The Mac builds are kicked off manually, but otherwise automated as described above.
