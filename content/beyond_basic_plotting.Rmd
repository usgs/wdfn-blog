...
```{r warning=FALSE, message=FALSE, fig.cap="Simple flow timeseries for site 03339500.", alt.text="Hydrograph produced by ggplot2 with USGS-style.", fig.width = 7, fig.height=5}
...
```{r warning=FALSE, message=FALSE, fig.cap="Multi-plot figure generated using cowplot.", alt.text="Three plots in one figure: boxplot of inorganic N & TSS, TSS vs flow, and hydrograph.", fig.width = 7, fig.height=5}
...
```{r warning=FALSE, message=FALSE, fig.cap="Grouped boxplot produced by ggplot2 with USGS style.", alt.text="Boxplots of water temperature for day and night grouped by USGS sites.", fig.width = 7, fig.height=5}
library(dataRetrieval)
