...
image: "static/beyond-basic-plotting/cowplot_multi_plot-1.png"
keyword1: "R"
...
```{r cowplot_multi_plot, warning=FALSE, message=FALSE, fig.cap="Multi-plot figure generated using cowplot.", alt.text="Three plots in one figure: boxplot of inorganic N & TSS, TSS vs flow, and hydrograph.", fig.width = 7, fig.height=5}
