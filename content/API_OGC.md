...
Conveniently add this event to your calendar by visting our Eventbrite page. You do not have provide any personal information, and you do not have to register for the event in order to attend (we've provided this option because many users requested a way to register for the event).
