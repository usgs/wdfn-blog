...
* Robert M. Hirsch
<a href="mailto:rhirsch@usgs.gov" target="blank"><i class="fas fa-envelope-square fa-2x"></i></a>
...
<a href="https://www.usgs.gov/staff-profiles/robert-hirsch" target="blank"><i class="fas fa-user fa-2x"></i></a>

* Laura DeCicco
<a href="mailto:ldecicco@usgs.gov" target="blank"><i class="fas fa-envelope-square fa-2x"></i></a>
<a href="https://twitter.com/DeCiccoDonk" target="blank"><i class="fab fa-twitter-square fa-2x"></i></a>
<a href="https://github.com/ldecicco-usgs" target="blank"><i class="fab fa-github-square fa-2x"></i></a>
...
<a href="https://www.usgs.gov/staff-profiles/laura-decicco" target="blank"><i class="fas fa-user fa-2x"></i></a>

Information on USGS-R packages used in this post:

| | |
|-------------|----------------------------------------------------|
|<a href="https://github.com/USGS-R/EGRET" target="_blank"><img src="/images/USGS_R.png" alt="USGS-R image icon" style="width: 75px;" /></a> | <a href="https://github.com/USGS-R/EGRET/issues" target="_blank">EGRET</a>: Exploration and Graphics for RivEr Trends: An R-package for the analysis of long-term changes in water quality and streamflow, including the water-quality method Weighted Regressions on Time, Discharge, and Season (WRTDS) |
