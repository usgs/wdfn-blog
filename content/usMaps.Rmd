...
```{r fakePoints, alt.text = "Sample US map including AK, HI, and PR.", fig.cap = "US map including AK, HI, and PR with fake data to test mapping function."}
library(dplyr)
library(ggplot2)
...
```{r plotIt, alt.text = "US map including AK, HI, and PR with USGS sites.", fig.cap = "US map including AK, HI, and PR with USGS sites that have measured phosphorus."}
