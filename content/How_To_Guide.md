...
<!--- SELECT PRESET ACCORDION SECTION START -->
...
<!--- ALTER TIMEFRAME ACCORDION SECTION START -->
...
<!--- DOWNLOAD DATA ACCORDION SECTION START -->
...
<!--- SELECT PARAMETERS ACCORDION SECTION START -->
...
<!--- HYDROGRAPH TABLES ACCORDION SECTION START -->
...
<!--- DIFF MAP LAYERS ACCORDION SECTION START -->
<h2 class="usa-accordion__heading"><button class="usa-accordion__button" aria-expanded="false" aria-controls="a11">
...
<!--- AFFILIATED NETWORKS ACCORDION SECTION START -->
...
<!--- SUMMARY OF ALL DATA ACCORDION SECTION START -->
...
<!--- LOCATION METADATA ACCORDION SECTION START -->
...
<!--- NAVIGATION ACCORDION SECTION START -->
...
<!--- DATA INFO ACCORDION SECTION START -->
<h2 class="usa-accordion__heading"><button class="usa-accordion__button" aria-expanded="false" aria-controls="a17">
Data Information <!--- 🚢🛥⛴🚀 -->
</button></h2>
<div id="a17" class="usa-accordion__content">
...
<!--- DATA INVENTORY ACCORDION SECTION START -->
