...
Similarly, we could create a map zoomed in to the HUC polygon.  Note that we set the x and y limits of the map using by extracting the limits by of the `bbox` object we created earlier.  We can use the names `left`, `right`, etc. because it is a named vector.  
