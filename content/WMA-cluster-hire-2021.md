...
- USGS-SAC-21-{check back soon} **Machine Learning Specialist**; _Tuscaloosa, AL_ duty station
- USGS-SAC-21-{check back soon} **Machine Learning Specialist**; _any_ duty station
...
> - _Required specialized experience for GS-12 Machine Learning Specialist:_ Experience includes advanced knowledge of various machine learning approaches (e.g., artificial neural networks, clustering tools, regression methods), advanced skills in applying machine learning libraries to build predictive models, and advanced understanding of modeled results.
