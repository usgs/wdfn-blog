...
<img src='/static/rResid/unnamed-chunk-2-1.png'/ alt='/plotConcTime problem'/>
...
<img src='/static/rResid/unnamed-chunk-3-1.png'/ alt='/plotConcQ problem'/>
...
<img src='/static/rResid/unnamed-chunk-4-1.png'/ alt='/plotResidQ problem'/>
...
<img class="sideBySide" src='/static/rResid/unnamed-chunk-5-1.png'/ alt='/Truncated normal distribution density thresh +1'/><img class="sideBySide" src='/static/rResid/unnamed-chunk-5-2.png'/ alt='/Truncated normal distribution thresh -1'/>
...
<img src='/static/rResid/unnamed-chunk-6-1.png'/ alt='/plotConcQ random 1'/>
...
<img src='/static/rResid/unnamed-chunk-6-2.png'/ alt='/plotConcQ random 2'/>
...
<img src='/static/rResid/unnamed-chunk-7-1.png'/ alt='/plotResidTime with random censoring'/>

``` r
plotResidQ(eList, qUnit = 4, randomCensored = TRUE)
```

<img src='/static/rResid/unnamed-chunk-7-2.png'/ alt='/plotResidQ with random censoring'/>
...
<img src='/static/rResid/unnamed-chunk-8-1.png'/ alt='/multiPlotDataOverview'/>

``` r
fluxBiasMulti(eList, qUnit = 4, fluxUnit = 9, randomCensored = TRUE)
```

<img src='/static/rResid/unnamed-chunk-8-2.png'/ alt='/fluxBiasMulti'/>
