...
{{< figure src="/static/wdfn-tng/nwisweb6_tng_hyperlink.png" title="How to link to new pages from NWISWeb" alt="Screenshot of how to link to new pages from NWISWeb" >}}
...
{{< figure src="/static/wdfn-tng/hi_res_new_pages.png" title="Mobile-friendly new real time data page" alt="Mobile-friendly new real time data page" >}}
