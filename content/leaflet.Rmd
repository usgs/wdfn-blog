...
One issue for our Hugo theme was that the created widget page is included in the overall blog section index. The was fixed by adding a line to the overall index.html layout page to only lists pages with dates above Jan. 1, 1970 (so really, any legitimate date):
...
A screenshot of the map was taken to use for the thumbnail in the blog section index.
