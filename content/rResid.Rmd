...
keyword1: random residuals
keyword2: water quality trends
---
...
```{r, echo=FALSE, fig.cap="plotConcTime problem", alt.text="plotConcTime issue"}
plotConcTime(eList)
```
...
```{r, echo=FALSE, fig.cap="plotConcQ problem", alt.text="plotConcQ issue"}
...
```{r, echo=FALSE, fig.cap="plotResidQ problem", alt.text="plotResidQ problem"}
...
```{r,echo=FALSE, fig.cap=c("Truncated normal distribution density thresh +1","Truncated normal distribution thresh -1"), alt.text="Truncated normal distribution images", class = 'side-by-side'}
...
```{r fig.cap=c("plotConcQ random 1", "plotConcQ random 2"), alt.text = "plotConcQ random images", class="side-by-side"}
...
```{r, fig.cap=c("plotResidTime with random censoring","plotResidQ with random censoring"), alt.text = "plotResidTime random images", class="side-by-side"}
...
```{r, fig.height = 9, fig.width = 8, fig.cap=c("multiPlotDataOverview","fluxBiasMulti"), alt.text = "EGRET example plots"}
