...
```{r, echo=FALSE, fig.cap="plotConcTime problem"}
plotConcTime(eList)
```
...
```{r, echo=FALSE, fig.cap="plotConcQ problem"}
...
```{r, echo=FALSE, fig.cap="plotResidQ problem"}
...
```{r,echo=FALSE, fig.cap=c("Truncated normal distribution density thresh +1","Truncated normal distribution thresh -1")}
...
```{r fig.cap=c("plotConcQ random 1", "plotConcQ random 2")}
...
```{r, fig.cap=c("plotResidTime with random censoring","plotResidQ with random censoring")}
...
```{r, fig.height = 9, fig.width = 8, fig.cap=c("multiPlotDataOverview","fluxBiasMulti")}
