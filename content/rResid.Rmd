...
```{r,echo=FALSE, fig.cap=c("Truncated normal distribution density thresh +1","Truncated normal distribution thresh -1"), alt.text="Truncated normal distribution images", class = 'sideBySide'}
...
```{r fig.cap=c("plotConcQ random 1", "plotConcQ random 2"), alt.text = "plotConcQ random images", class="sideBySide"}
...
```{r, fig.cap=c("plotResidTime with random censoring","plotResidQ with random censoring"), alt.text = "plotResidTime random images", class="sideBySide"}
