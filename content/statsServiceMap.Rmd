...
currentWD <- getwd()
dir.create("static/stats-service-map", showWarnings = FALSE)
setwd("static/stats-service-map")
saveWidget(leafMapStat, "leafMapStat.html")
setwd(currentWD)

```

<iframe seamless src="/static/stats-service-map/leafMapStat/index.html" width="100%" height="500"></iframe>
