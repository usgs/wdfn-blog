...
```{r message=FALSE, fig.show='hold', out.width=c('300px', '300px'), fig.cap=c("ggplot2 Concentration Flow plot","EGRET Concentration Flow plot"), htmlcap="ggplot2 vs EGRET Concentration Discharge plots"}
library(EGRET)
library(ggplot2)
...
```{r fig.show='hold', out.width=c('300px', '300px'),fig.cap=c("ggplot2 Monthly boxplot", "EGRET monthly boxplot"), htmlcap="ggplot2 vs EGRET Monthly Concentration Boxplots"}
...
```{r fig.cap="Custom plotFlowConc", htmlcap="Custom plotFlowConc output"}
