...
```{r plotConcQ, message=FALSE, fig.show='hold', out.width=c('300px', '300px'), fig.cap=c("ggplot2 Concentration Flow plot","EGRET Concentration Flow plot"), alt.text='ggplot vs EGRET', class = 'sideBySide'}
library(EGRET)
library(ggplot2)
