...
```{r plotConcQ, message=FALSE, fig.show='hold', out.width=c('300px', '300px'), fig.cap=c("ggplot2 Concentration Flow plot","EGRET Concentration Flow plot"), htmlcap="Plot on the left was produced by ggplot2 and the plot on the right was produced by plotConcQ from the EGRET package."}
library(EGRET)
library(ggplot2)
...
```{r plotFlowConc, fig.cap="Custom plotFlowConc"}
