...
# This gets the div started...but I can't seem to get the trailing div closure to work
...
* Marcus Beck from the USEPA ( <beck.marcus@epa.gov>)
<a href="https://twitter.com/fawda123"><i class="fab fa-twitter-square fa-2x" aria-hidden="true"></i></a>
<a href="https://github.com/fawda123"><i class="fab fa-github-square fa-2x" aria-hidden="true"></i></a>
...
* Laura DeCicco from the USGS (OWI) (<ldecicco@usgs.gov>)
<a href="https://twitter.com/DeCiccoDonk"><i class="fab fa-twitter-square fa-2x" aria-hidden="true"></i></a>
<a href="https://github.com/ldecicco-usgs"><i class="fab fa-github-square fa-2x" aria-hidden="true"></i></a>
...
```{r plotConcQ, message=FALSE, fig.show='hold', out.width=c('300px', '300px'), fig.cap=c("ggplot2 Concentration Flow plot","EGRET Concentration Flow plot"), alt.text='ggplot vs EGRET', class = 'side-by-side'}
library(EGRET)
library(ggplot2)
...
```{r plotFlowConc, fig.cap="Custom plotFlowConc", alt.text="Custom ggplot2 plotFlowConc image"}
