...
```{r change_namesDisplay, echo=FALSE}
...
```{r tabIMAGE, echo=FALSE, fig.cap="Wide data that needs to be converted to a long format.", alt.text = "Screen shot of Excel spreadsheet."}
knitr::include_graphics("static/pivot/messyData.png")
```
